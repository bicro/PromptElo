...
mkdir -p "$PROMPTELO_DIR/skills/setup"
...
cp "$REPO_DIR/skills/setup/SKILL.md" "$PROMPTELO_DIR/skills/setup/"
...
echo "  • Run /promptelo:setup to customize settings"
echo ""
echo "On first run, you'll see a welcome message with your auto-generated anonymous ID."
echo ""
